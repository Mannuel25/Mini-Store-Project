def DescendingOrderSorting():
    """
    Sorts and displays items in descending order
    of description, net weight, quantity
    :return: None
    """
    filename = 'myStore.txt'
    print('\n+ Enter a to sort in descending order of item description')
    print('+ Enter b to sort in descending order of item net weight')
    print('+ Enter c to sort in descending order of item quantity')
    ...
    while user_input not in possible_picks:
        ...
        items_quantity.sort()
        if user_input == 'a':
            print('\nSorting description in descending order [z-a]')
            for key,value in sorted(items_details.items(),reverse=True):
                print('\n' + '-' * 34)
            ...
            # each item in descending order of their net weight
            new_list = []
            print('\nSorting net weight in descending order ⬇')
            details_values.reverse()
            ...
            # descending order of their quantity
            new_list_1.reverse()
            for i in new_list_1:
